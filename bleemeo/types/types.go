...
type GlobalOption struct {
	...
	UpdateThresholds       func(ctx context.Context, thresholds map[threshold.MetricKey]threshold.Threshold, firstUpdate bool)
	UpdateUnits            func(units map[threshold.MetricKey]threshold.Unit)
