...
func TestRenamePipeline(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			wantMetric:  "vault_core_leadership_losses",
			wantValue:   2,
		},
		{
			...
			wantMetric:  "vault_core_handle_requests",
			wantValue:   5,
		},
		{
			...
			wantMetric:  "vault_core_handle_login_requests",
			wantValue:   1,
		},
		{
			...
			wantMetric:  "vault_core_check_tokens",
			wantValue:   3,
		},
		{
