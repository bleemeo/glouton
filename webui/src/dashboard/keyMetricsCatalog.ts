...
export const SERVICE_KEY_METRICS: Record<string, ServiceKeyMetric[]> = {
  redis: [
    ...
    {
      metric: "redis_current_connections",
      label: "Connected clients",
      format: "count",
      color: ACCENT_VIOLET,
    },
    {
      metric: "redis_total_operations",
      label: "Ops/s",
      format: "rate",
      color: ACCENT_GREEN,
    },
  ...
  postgresql: [
    {
      metric: "postgresql_connections_used_perc",
      label: "Connections",
      format: "percent",
      yMax: 100,
      color: ACCENT_BLUE,
    ...
    {
      metric: "postgresql_commit",
      label: "Commits/s",
      format: "rate",
      color: ACCENT_VIOLET,
    },
    {
      metric: "postgresql_rollback",
      label: "Rollbacks/s",
      format: "rate",
      color: "#EF4444",
    },
  ...
  elasticsearch: [
    {
      metric: "elasticsearch_search_query",
      label: "Queries/s",
      format: "rate",
      color: ACCENT_BLUE,
    },
    {
      metric: "elasticsearch_docs_count",
      label: "Documents",
      format: "count",
      color: ACCENT_VIOLET,
    },
  ...
  cassandra: [
    {
      metric: "cassandra_jvm_heap_used",
      label: "JVM heap",
      format: "bytes",
      color: ACCENT_BLUE,
    },
    {
      metric: "cassandra_read_requests",
      label: "Reads/s",
      format: "rate",
      color: ACCENT_VIOLET,
    },
  ...
  memcached: [
    {
      metric: "memcached_curr_connections",
      label: "Connections",
      format: "count",
      color: ACCENT_BLUE,
    },
    {
      metric: "memcached_get_hits",
      label: "Cache hits/s",
      format: "rate",
      color: ACCENT_VIOLET,
    },
