export const CONTAINERS_URL = "/data/docker-containers";
export const AGENT_INFORMATIONS_URL = "/data/agent-informations";
export const AGENT_STATUS_URL = "/data/agent-status";
