...
func NewHTTP(urlValue string, persitentAddresses []string, expectedStatusCode int, labels map[string]string, acc accumulator) *HTTPCheck {
	...
	hc.baseCheck = newBase(mainTCPAddress, persitentAddresses, true, hc.doCheck, labels, acc)
	return hc
}
