...
func (dd *DynamicDiscovery) Discovery(ctx context.Context) ([]Service, error) {
...
func (dd *DynamicDiscovery) updateDiscovery(ctx context.Context) ([]Service, error) {
	processes, err := dd.option.PS.Processes(ctx, 0)
	if err != nil {
		return nil, err
	}
