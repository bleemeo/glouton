...
var request5 = []byte{0x00, 0x02, 0x00, 0x01, 0x0d, 0x5e, 0x9d, 0x3a,
	0x45, 0x69, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x5f,
	0x62, 0x69, 0x67, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
func TestDecode(t *testing.T) {
	cases := []struct {
		...
		{bytes.NewReader(request5), reducedPacket{1, 17769, "check_big"}},
	}
	for _, c := range cases {
		got, err := decode(c.in)
		if got != c.want {
